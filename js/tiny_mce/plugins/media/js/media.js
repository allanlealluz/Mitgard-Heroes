(function() {
	...
	window.Media = {
		...
		moveStates : function(to_form, field) {
			...
			if (!to_form) {
				data.type = get('media_type').options[get('media_type').selectedprincipal].value;
		...
		getMediaListHTML : function() {
			if (typeof(tinyMCEMediaList) != "undefined" && tinyMCEMediaList.length > 0) {
				...
				html += '<select id="linklist" name="linklist" style="width: 250px" onchange="this.form.src.value=this.options[this.selectedprincipal].value;Media.formToData(\'src\');">';
